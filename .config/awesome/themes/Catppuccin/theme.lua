...
theme.wallpaper = themes_path.."Catppuccin/background.jpg"

-- You can use your own layout icons like this:
theme.layout_fairh      = themes_path .. "default/layouts/fairhw.png"
theme.layout_fairv      = themes_path .. "default/layouts/fairvw.png"
theme.layout_floating   = "/home/sv/.config/awesome/Icons-AwesomeWM-Layouts-pastel/floating.png"
theme.layout_magnifier  = themes_path .. "default/layouts/magnifierw.png"
theme.layout_max        = "/home/sv/.config/awesome/Icons-AwesomeWM-Layouts-pastel/max.png"
theme.layout_fullscreen = themes_path .. "default/layouts/fullscreenw.png"
theme.layout_tilebottom = themes_path .. "default/layouts/tilebottomw.png"
theme.layout_tileleft   = "/home/sv/.config/awesome/Icons-AwesomeWM-Layouts-pastel/tileleft.png"
...
-- Bling Flash
theme.flash_focus_start_opacity = 0.3 -- the starting opacity
theme.flash_focus_step = 0.01         -- the step of animation

-- Window Switcher
theme.window_switcher_widget_bg = "#333333"              -- The bg color of the widget
theme.window_switcher_widget_border_width = 3            -- The border width of the widget
theme.window_switcher_widget_border_radius = 12           -- The border radius of the widget
theme.window_switcher_widget_border_color = "#FB8C00"    -- The border color of the widget
...
theme.window_switcher_name_forced_width = 250            -- The width of one title
theme.window_switcher_name_font = "sans 14"              -- The font of all titles
theme.window_switcher_name_normal_color = "#ffffff"      -- The color of one title if the client is unfocused
theme.window_switcher_name_focus_color = "#FB8C00"       -- The color of one title if the client is focused
